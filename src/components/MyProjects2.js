...
function MyProjects() {
    return (
        <div className="myProjects-main" id="MyProjects">
            ...
            <section className="projectsSection">
                ...
                <div className="covidProject">
                    <div>
                        <a href="https://erkonz.github.io/production4/#/" target="_blank" rel="noopener noreferrer">
                            {/* <img src={movingPicCovid} loading="lazy" alt="covid19" /> */}
                            <img src={laptopmobile1} loading="lazy" alt="covid19" />
                        </a>
                    </div>
                    <div>
                ...
                <div className="hotelProject">
                    ...
                    <div><a href="http://ishotelbc2.epizy.com/zabransky/uvod.php" rel="noopener noreferrer" target="_blank" >
                        <img src={movingPicEminent} loading="lazy" alt="hotel Bc" /></a></div>
                </div>
